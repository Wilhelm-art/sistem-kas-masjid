                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.transactions.update', $transaction->id) }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <input type="hidden" name="cashbook_id" id="cashbook_id" value="{{ $transaction->cashbook_id }}">

                            <div>
                                <label for="date" class="block font-medium text-sm text-gray-700">Tanggal</label>
                                <input id="date" type="date" name="date" value="{{ old('date', $transaction->date) }}" class="mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                @error('date')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="description" type="text" name="description" value="{{ old('description', $transaction->description) }}" class="mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                @error('description')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="amount" type="number" name="amount" value="{{ old('amount', $transaction->amount) }}" class="mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                @error('amount')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
